...
async function renderBooks() {
  ...
  booksWrapper.classList.remove('books__loading')
    ...
    if (filter === 'Low_TO_HIGH') {
     const filteredBooks = books.sort ((a, b) => (a.salePrice || a.orignalPrice)- (b.salePrice || b.orignialPrice))
    )}
    else if (filter === 'HIGH_TO_LOW') {
      const filteredBooks = books.sort ((a, b) => ((b.salePrice || b.orignalPrice)- (a.salePrice || a.orignialPrice))
    )}
